...
<html lang="en">
  ...
  <body id="welcome">
    ...
    <h6>Pedagogical Note:<br>When this page is first displayed, all 
        text is displayed in the default text color of black. Then 
        the time <br>and date are dynamically updated every 60 seconds, 
        and each time this happens the two lines of text <br>containing
        the date and time are shown in a color chosen randomly from 
        one of these four colors: red, <br>green, blue, or maroon. The
        remaining lines of text on the page (including this note) 
        retain their (static) <br>default color black. 
    </h6>
    <script>
      getCurrentTime();
